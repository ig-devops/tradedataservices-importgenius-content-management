 ...
 */
class LandingPageRemovalToolFeature extends FeatureContext implements Context
{
     ...
     */
    public function iRemoveTheLandingPage()
    {
        ...
        $command = RemoveLandingPage::create($id, $this->employee, $this->landingPage);

        // Create Handler
        $handler = RemoveLandingPageHandler::create(
                $this->publishedLandingPageRepository, $this->privacyRequestRepository, $this->blacklistedLandingPageRepository
        );
