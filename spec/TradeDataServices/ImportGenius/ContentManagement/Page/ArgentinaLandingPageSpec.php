...
use TradeDataServices\ImportGenius\ContentManagement\Page\ArgentinaLandingPage;
...
class ArgentinaLandingPageSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(ArgentinaLandingPage::class);
    ...
    {
        $this->countryAbbreviation()->shouldReturn("AR");
    ...
    {
        $this->country()->shouldReturn("Argentina");
