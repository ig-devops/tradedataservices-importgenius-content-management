...
use TradeDataServices\ImportGenius\ContentManagement\Page\ChileLandingPage;
...
class ChileLandingPageSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(ChileLandingPage::class);
    ...
    {
        $this->countryAbbreviation()->shouldReturn("CL");
    ...
    {
        $this->country()->shouldReturn("Chile");
