...
use TradeDataServices\ImportGenius\ContentManagement\Page\ColombiaLandingPage;
...
class ColombiaLandingPageSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(ColombiaLandingPage::class);
    ...
    {
        $this->countryAbbreviation()->shouldReturn("CO");
    ...
    {
        $this->country()->shouldReturn("Colombia");
