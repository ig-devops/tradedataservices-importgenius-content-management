...
use TradeDataServices\ImportGenius\ContentManagement\Page\CostaRicaLandingPage;
...
class CostaRicaLandingPageSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(CostaRicaLandingPage::class);
    ...
    {
        $this->countryAbbreviation()->shouldReturn("CR");
    ...
    {
        $this->country()->shouldReturn("Costa Rica");
