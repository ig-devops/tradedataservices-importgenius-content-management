...
use TradeDataServices\ImportGenius\ContentManagement\Page\IndiaLandingPage;
...
class IndiaLandingPageSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(IndiaLandingPage::class);
    ...
    {
        $this->countryAbbreviation()->shouldReturn("IN");
    ...
    {
        $this->country()->shouldReturn("India");
