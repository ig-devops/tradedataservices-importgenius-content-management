...
use TradeDataServices\ImportGenius\ContentManagement\Page\PanamaLandingPage;
use TradeDataServices\ImportGenius\ContentManagement\TraderType\TraderType;

class PanamaLandingPageSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(PanamaLandingPage::class);
    ...
    {
        $this->countryAbbreviation()->shouldReturn("PA");
    ...
    {
        $this->country()->shouldReturn("Panama");
