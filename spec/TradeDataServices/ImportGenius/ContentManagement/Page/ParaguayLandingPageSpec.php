...
use TradeDataServices\ImportGenius\ContentManagement\Page\ParaguayLandingPage;
use TradeDataServices\ImportGenius\ContentManagement\TraderType\TraderType;

class ParaguayLandingPageSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(ParaguayLandingPage::class);
    ...
    {
        $this->countryAbbreviation()->shouldReturn("PY");
    ...
    {
        $this->country()->shouldReturn("Paraguay");
