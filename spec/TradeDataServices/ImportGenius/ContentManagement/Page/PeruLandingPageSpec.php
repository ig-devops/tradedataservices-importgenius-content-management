...
use TradeDataServices\ImportGenius\ContentManagement\Page\PeruLandingPage;
use TradeDataServices\ImportGenius\ContentManagement\TraderType\TraderType;

class PeruLandingPageSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(PeruLandingPage::class);
    ...
    {
        $this->countryAbbreviation()->shouldReturn("PE");
    ...
    {
        $this->country()->shouldReturn("Peru");
