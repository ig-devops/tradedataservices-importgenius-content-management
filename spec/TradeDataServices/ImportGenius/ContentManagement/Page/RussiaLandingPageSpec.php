...
use TradeDataServices\ImportGenius\ContentManagement\Page\RussiaLandingPage;
use TradeDataServices\ImportGenius\ContentManagement\TraderType\TraderType;

class RussiaLandingPageSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(RussiaLandingPage::class);
    ...
    {
        $this->countryAbbreviation()->shouldReturn("RU");
    ...
    {
        $this->country()->shouldReturn("Russia");
