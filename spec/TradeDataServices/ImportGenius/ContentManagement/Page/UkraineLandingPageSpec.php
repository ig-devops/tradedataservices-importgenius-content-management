...
use TradeDataServices\ImportGenius\ContentManagement\Page\UkraineLandingPage;
use TradeDataServices\ImportGenius\ContentManagement\TraderType\TraderType;

class UkraineLandingPageSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(UkraineLandingPage::class);
    ...
    {
        $this->countryAbbreviation()->shouldReturn("UA");
    ...
    {
        $this->country()->shouldReturn("Ukraine");
