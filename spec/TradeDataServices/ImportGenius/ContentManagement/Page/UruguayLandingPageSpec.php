...
use TradeDataServices\ImportGenius\ContentManagement\Page\UruguayLandingPage;
use TradeDataServices\ImportGenius\ContentManagement\TraderType\TraderType;

class UruguayLandingPageSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(UruguayLandingPage::class);
    ...
    {
        $this->countryAbbreviation()->shouldReturn("UY");
    ...
    {
        $this->country()->shouldReturn("Uruguay");
