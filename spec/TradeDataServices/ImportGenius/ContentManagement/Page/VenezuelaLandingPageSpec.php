...
use TradeDataServices\ImportGenius\ContentManagement\Page\VenezuelaLandingPage;
use TradeDataServices\ImportGenius\ContentManagement\TraderType\TraderType;

class VenezuelaLandingPageSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(VenezuelaLandingPage::class);
    ...
    {
        $this->countryAbbreviation()->shouldReturn("VE");
    ...
    {
        $this->country()->shouldReturn("Venezuela");
