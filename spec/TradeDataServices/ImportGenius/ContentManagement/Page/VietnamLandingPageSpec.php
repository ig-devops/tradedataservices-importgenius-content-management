...
use TradeDataServices\ImportGenius\ContentManagement\Page\VietnamLandingPage;
use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use TradeDataServices\ImportGenius\ContentManagement\TraderType\TraderType;

class VietnamLandingPageSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(VietnamLandingPage::class);
    ...
    {
        $this->countryAbbreviation()->shouldReturn("VN");
    }

    function it_has_Country()
    {
        $this->country()->shouldReturn("Vietnam");
    }
}
