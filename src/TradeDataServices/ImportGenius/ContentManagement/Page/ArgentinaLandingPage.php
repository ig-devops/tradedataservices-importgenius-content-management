...
class ArgentinaLandingPage extends LandingPage implements Entity
{


    public static function create(Id $id, TraderType $traderType, $url)
    {
        $landingPage = new ArgentinaLandingPage($id, $traderType, $url);
        $landingPage->setCountryAbbreviation('AR');
        $landingPage->setCountry('Argentina');
