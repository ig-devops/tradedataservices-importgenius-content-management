...
class EcuadorLandingPage extends LandingPage implements Entity
{


    public static function create(Id $id, TraderType $traderType, $url)
    {
        $landingPage = new EcuadorLandingPage($id, $traderType, $url);
        $landingPage->setCountryAbbreviation('EC');
        $landingPage->setCountry('Ecuador');
