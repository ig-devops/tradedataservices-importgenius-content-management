...
class PeruLandingPage extends LandingPage implements Entity
{


    public static function create(Id $id, TraderType $traderType, $url)
    {
        $landingPage = new PeruLandingPage($id, $traderType, $url);
        $landingPage->setCountryAbbreviation('PE');
        $landingPage->setCountry('Peru');
