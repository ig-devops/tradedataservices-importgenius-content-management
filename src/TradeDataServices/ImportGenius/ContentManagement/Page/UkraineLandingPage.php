...
class UkraineLandingPage extends LandingPage implements Entity
{


    public static function create(Id $id, TraderType $traderType, $url)
    {
        $landingPage = new UkraineLandingPage($id, $traderType, $url);
        $landingPage->setCountryAbbreviation('UA');
        $landingPage->setCountry('Ukraine');
