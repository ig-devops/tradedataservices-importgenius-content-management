...
class UnitedStatesLandingPage extends LandingPage implements Entity
{


    public static function create(Id $id, TraderType $traderType, $url)
    {
        $landingPage = new UnitedStatesLandingPage($id, $traderType, $url);
        $landingPage->setCountryAbbreviation('US');
        $landingPage->setCountry('United States');
