...
class VenezuelaLandingPage extends LandingPage implements Entity
{


    public static function create(Id $id, TraderType $traderType, $url)
    {
        $landingPage = new VenezuelaLandingPage($id, $traderType, $url);
        $landingPage->setCountryAbbreviation('VE');
        $landingPage->setCountry('Venezuela');
